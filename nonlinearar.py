...
if __name__ == "__main__":
    ...
    xtrain=pandas.concat([df["Today"][0:300],df["Volume"][0:300],df["Lag1"][0:300]],axis=1,keys=["Today","Volume","Lag1"])
    ytrain=df["Today"][0:300]
    xtest=pandas.concat([df["Today"][300:],df["Volume"][300:],df["Lag1"][300:]],axis=1,keys=["Today","Volume","Lag1"])
    ytest=df["Today"][300:]
    print(xtrain)
